...
//        print(lng)
    ...
    @IBAction func getCurrentLocation(_ sender: Any) {
        ...
        url += "&aggregateHours=24&unitGroup=us&shortColumnNames=false&contentType=json&key=QZZXP28UZX39ZELJRFRLUM9G4"
...
//                print(forecast)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = self.temps[indexPath.row] as String
        return cell
